...
const slotMap: Record<string, string[]> = {
  // Format: yyyy-MM-dd
  '2025-05-20': ['2:30pm', '8:00pm', '8:30pm', '9:00pm'], // Tuesday
  '2025-05-21': ['2:30pm', '8:00pm', '2:30pm', '8:30pm', '9:00pm'], // Wednesday
}

// Fetch slots by date key
...
export default function BookingModal() {
  ...
  const weekStart = startOfWeek(addDays(today, weekOffset * 7), { weekStartsOn: 1 }) // Start Monday
